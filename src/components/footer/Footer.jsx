...
const Footer = () => {
    const menu = [
      ...
      const socialMedia = [
        {
          id: 1,
          img: <svg fill="white" width="18px" height="18px" viewBox="-5.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="white">
        ...
        {
          id: 2,
          img: <svg fill="#fff" width="15px" height="15px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg" stroke="#fff">
        ...
        {
          id: 3,
          img: <svg fill="white" height="15px" width="15px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-271 273 256 256" xml:space="preserve" stroke="white">
        ...
        {
            id: 4,
            img: <svg width="15px" height="15px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#fff">
  ...
  return (
    <div className='footer'>
        ...
        <List list= {menu} className='footer__menu'/>
        </div>
        <div className='footer__media'>
        <List list= {socialMedia} className="footer__media"/>
        </div>
        <span className='footer__rights'>© 2021 Loopstudios. All rights reserved.</span>
    </div>
  )
}
